...
import { Building2, UserCircle, LogOut, ChevronDown, Check, Shield, UserCog, Heart, Repeat, Menu, Lock } from "lucide-react";
                    ...
                    <AnimatePresence>
                        {isDropdownOpen && (
                            ...
                            >
                                ...
                                {/* Options */}
                                <div className="p-2 border-b border-muted/20 space-y-1">
                                    <button
                                        onClick={() => {
                                            setIsDropdownOpen(false);
                                            setIsChangePasswordOpen(true);
                                        }}
                                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-muted/50 transition-all cursor-pointer group/item"
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest">Seguridad de cuenta</p>
                                        </div>
                                    </button>
                                    ...
                                    {roles.length > 1 && (
                                        <Link
                                            ...
                                            className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-muted/50 transition-all cursor-pointer group/switch"
                                        >
